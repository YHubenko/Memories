/**
 * Controls the game, remembers opened cards, control deck and counts number of attempts.
...
class GameManager {
    ...
    constructor(board, score) {
        if (typeof board === 'string') this.#boardElement = document.querySelector(board);
        else this.#boardElement = board;

        if (typeof score === 'string') this.#scoreElement = document.querySelector(score);
        else this.#scoreElement = score;
    }
